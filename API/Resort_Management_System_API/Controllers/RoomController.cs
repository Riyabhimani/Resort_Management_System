...
namespace Resort_Management_System_API.Controllers
{
    ...
    public class RoomController : ControllerBase
    {
        ...
        public RoomController(ResortManagementContext context, IValidator<Room> validator, IWebHostEnvironment env)
        {
        ...
        #region UploadRoomPicture

        [HttpPost("{id}/upload-picture")]
        public async Task<IActionResult> UploadRoomPicture(int id, IFormFile file)
        {
            ...
            // Save relative path to DB (not full server path)
            room.RoomPicture = Path.Combine("images/rooms", fileName).Replace("\\", "/");
            context.Rooms.Update(room);
            await context.SaveChangesAsync();

            return Ok(new { room.RoomId, room.RoomPicture });
        }
